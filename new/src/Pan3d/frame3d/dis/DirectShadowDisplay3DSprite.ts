module Pan3d {
    ...
    export class DirectShadowDisplay3DSprite extends Display3DSprite {
        ...
        private _rotationMatrix: Matrix3D;
        public updateRotationMatrix(): void {

            this._rotationMatrix.identity();
            this._rotationMatrix.appendRotation(this.rotationX, Vector3D.X_AXIS);
            this._rotationMatrix.appendRotation(this.rotationY, Vector3D.Y_AXIS);
            this._rotationMatrix.appendRotation(this.rotationZ, Vector3D.Z_AXIS);
        ...
        public setModelById($str: string): void {
            ...
            this.scene3D.groupDataManager.getGroupData(this.scene3D.fileRoot + getModelUrl($str), (groupRes: GroupRes) => {
