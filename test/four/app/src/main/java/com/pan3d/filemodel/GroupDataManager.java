...
import com.example.four.Display3DSpriteCopy;
...
import com.pan3d.display.basedis.DisplayBaseSprite;
            ...
            public void Bfun(GroupRes groupRes) {
                for (int i = 0; i < groupRes.dataAry.size(); i++) {
                    ...
                    if (item.types == BaseRes.SCENE_PARTICLE_TYPE) {
                        ...
                        Display3DSpriteCopy display   = new Display3DSpriteCopy(scene3D);
