...
class View: SCNView {
    ...
    guard let eventsDelegate = eventsDelegate where eventsDelegate.keyDown(view: self, theEvent: theEvent) else {
    ...
    guard let eventsDelegate = eventsDelegate where eventsDelegate.keyUp(view: self, theEvent: theEvent) else {
