...
(function (cannondis) {
    ...
    var NoShadowShader = /** @class */ (function (_super) {
        __extends(NoShadowShader, _super);
        function NoShadowShader() {
            return _super.call(this) || this;
        }
        NoShadowShader.prototype.binLocation = function ($context) {
            $context.bindAttribLocation(this.program, 0, "v3Position");
            $context.bindAttribLocation(this.program, 1, "v2CubeTexST");
            $context.bindAttribLocation(this.program, 2, "v3Normal");
        };
        NoShadowShader.prototype.getVertexShaderString = function () {
        ...
        NoShadowShader.prototype.getFragmentShaderString = function () {
        ...
        NoShadowShader.NoShadowShader = "NoShadowShader";
        return NoShadowShader;
    }(Shader3D));
    cannondis.NoShadowShader = NoShadowShader;
    var DirectShadowColorShader = /** @class */ (function (_super) {
        ...
        DirectShadowColorShader.prototype.getFragmentShaderString = function () {
            var $str = "precision mediump float;\n" +
                ...
                "colorend.xyz=colorend.xyz+(toColor.xyz-colorend.xyz)*a; " +
                "gl_FragColor = colorend; " +
                //  "gl_FragColor =  vec4(225.0/255.0, 120.0/255.0, 0, 1); " +
                "}";
            return $str;
        };
    ...
    cannondis.DirectShadowColorShader = DirectShadowColorShader;
    ...
    cannondis.DirectShadowColorSprite = DirectShadowColorSprite;
})(cannondis || (cannondis = {}));
