...
var AppDataArpg = /** @class */ (function () {
    ...
    AppDataArpg.math3dto2Darpg = function ($p) {
        ...
        var fovw = Scene_data.stageWidth / 4 / UIData.htmlScale;
        var fovh = Scene_data.stageHeight / 4 / UIData.htmlScale;
    ...
    AppDataArpg.resetSelfPosCenter = function () {
        if (GameInstance.mainChar) {
            ...
            var $tw = Scene_data.stageWidth / 4 / UIData.htmlScale;
            var $th = Scene_data.stageHeight / 4 / UIData.htmlScale;
