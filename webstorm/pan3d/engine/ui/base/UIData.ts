module Pan3d {
    export class MainUiLoad {
        ...
        private static loadUIdata($xmlUrl: string, $imgUrl: string, $key: string = "default", $isTexture: boolean = false): void {
            if (!$isTexture) {
                var kim: HTMLImageElement = makeImage()
