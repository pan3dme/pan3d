...
module Pan3d {
    ...
    export  class Pan3dByteArray {
        ...
        public setdata(srcByte: Pan3dByteArray): void {
        ...
        public setByte(i: number, num: number): void {
         ...
         */
        public readBytes(bytes: Pan3dByteArray, offset: number = 0, length: number = 0): void {
            //if (length == 0) {
        ...
        public readStringByLen(len: number): string {
         ...
         */
        public writeBytes(bytes: Pan3dByteArray, offset: number = 0, length: number = 0): void {
        ...
        public writeString(value: string): void {
            var strByteArray: Pan3dByteArray = new Pan3dByteArray();
        ...
        public writeStringByLen(value: string, len: number): void {

            var curPos: number = this.position;
