class SceneChar extends SceneBaseChar {
    ...
    private _wingDisplay: SceneBaseChar;
    public setWing(): void {
    ...
    */
    ...
    public fixAstartData(pos: Vector2D): void {
        ...
        //var $pt: Vector3D = AstarUtil.getWorldPosByStart2D(this.pixel2d);
        //this.px = $pt.x;
        //this.pz = $pt.z;
    }
    ...
    public getAstarPos(): Vector2D {
        return SceneAstarModel.getInstance().getAstarBySceneV3D(this.getCurrentPos())
    }
    ...
    //public pixel2d: Vector2D;
    //public reset2DposTo3d(): void {
    //    var $v2d: Vector2D = new Vector2D();
    //    $v2d.x = AppDataArpg.sceneStagePos.x + this.pixel2d.x;
    //    $v2d.y = AppDataArpg.sceneStagePos.y + this.pixel2d.y;
