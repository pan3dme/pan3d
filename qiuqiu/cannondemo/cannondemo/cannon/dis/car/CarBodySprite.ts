...
module canonkey {
    ...
    export class CarOptions implements CANNON.IWheelInfoOptions {
    ...
    */
    ...
    export  class CarBodySprite extends BaseMachine {
        ...
        public getBodyRotationY(): number {
            ...
            var $shapeQua: Quaternion = Physics.Quaternion2W(this.carvehicle.chassisBody.shapeOrientations[0]);
