    ...
    var LoaderThread = /** @class */ (function () {
        function LoaderThread() {
            ...
            this._xhr.onprogress = function (e) {
                if (_this._loadInfo && _this._loadInfo.progressFun) {
        ...
        LoaderThread.prototype.makeNewImg = function () {
            var _this = this;
            this._img = makeImage();
        ...
        LoaderThread.prototype.loadError = function () {
            if (this._loadInfo && this._loadInfo.info) {
                if (this._loadInfo.info.info) { //需要特别说明兼容
                    ...
                    this._loadInfo.info.failfun && this._loadInfo.info.failfun();
                }
            }
            console.log("文件加载错==>", this._loadInfo);
            this.idle = true;
            this._loadInfo = null;
