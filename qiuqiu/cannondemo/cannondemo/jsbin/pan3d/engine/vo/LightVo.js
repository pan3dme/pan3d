...
(function (Pan3d) {
    var LightVo = /** @class */ (function () {
        ...
        LightVo.prototype.clone = function () {
            var $vo = new LightVo;
            $vo.sunDirect = new Array(this.sunDirect[0], this.sunDirect[1], this.sunDirect[2]);
            $vo.sunColor = new Array(this.sunColor[0], this.sunColor[1], this.sunColor[2]);
            $vo.ambientColor = new Array(this.ambientColor[0], this.ambientColor[1], this.ambientColor[2]);
            return $vo;
        };
        return LightVo;
    }());
