module Pan3d {
    export class ResManager extends ResGC {
        ...
        public loadSceneRes($url: string, $completeFun: Function, $progressFun: Function, $readDataFun: Function, $info: any = null): SceneRes {
            ...
            sceneRes.load($url, $completeFun, $progressFun, $readDataFun, $info);
