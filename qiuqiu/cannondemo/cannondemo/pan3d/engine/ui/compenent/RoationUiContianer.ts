module Pan3d {
    export class RoationUIShader extends Shader3D {
    ...
    export  class RoationUIRenderComponent extends UIRenderComponent {
        public constructor() {
            super();
        }
        public update(): void {
    ...
    export   class RoationUICompenent extends UICompenent {
        public constructor() {
            super();
        }
