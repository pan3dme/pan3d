...
module Pan3d {
    export class MathClass {
        ...
        static getCamView(_Cam: Camera3D, _focus_3d: Object3D): Float32Array {
            ...
            $m.appendRotation(-_focus_3d.rotationZ, Vector3D.Z_AXIS);
            ...
            _Cam.rotationZ = _focus_3d.rotationZ;
            ...
            _Cam.cameraMatrix.prependRotation(_Cam.rotationZ, Vector3D.Z_AXIS);
        ...
        public static SetShock: boolean = true
        private static camOffSetShock(_Cam: Camera3D): void {
            if (this.SetShock) {
