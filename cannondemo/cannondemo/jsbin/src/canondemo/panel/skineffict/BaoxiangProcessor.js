...
(function (skineffict) {
    ...
    skineffict.BaoxiangEvent = BaoxiangEvent;
    ...
    skineffict.BaoxiangModule = BaoxiangModule;
            ...
            switch ($event.type) {
                case BaoxiangEvent.SHOW_BAOXIANG_PANEL:
                    if (!this._resetPlayPanel) {
                        this._resetPlayPanel = new skineffict.BaoxiangPanel();
                    }
    ...
    skineffict.BaoxiangProcessor = BaoxiangProcessor;
