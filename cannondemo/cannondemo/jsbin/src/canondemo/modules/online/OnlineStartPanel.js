...
(function (online) {
    ...
    var OnlineStartPanel = /** @class */ (function (_super) {
        ...
        OnlineStartPanel.prototype.loadConfigCom = function () {
            ...
            ;
            this.base_tip_bg.addEventListener(InteractiveEvent.Down, this.butClik, this);
            this.base_tip_bg.addEventListener(InteractiveEvent.Up, this.butClik, this);
            this.showPanel();
        };
        ...
        OnlineStartPanel.prototype.showPanel = function () {
            if (this.uiLoadComplte) {
                ...
                this.clearAll();
                this.getWebUser();
                console.log("openid", GameData.getStorageSync("openid"));
            }
            else {
                if (this.h5UIAtlas) {
