...
var canonkey;
(function (canonkey) {
    var Hinge_html = /** @class */ (function (_super) {
        ...
        Hinge_html.prototype.car = function () {
            ...
            for (var i = 0; i < bodies.length; i++) {
                var $disLock = new canonkey.CanonPrefabSprite(bodies[i]);
                $disLock.addToWorld();
            }
            // Ground
            ...
            ground.position.z = -3;
            var $disLock = new canonkey.CanonPrefabSprite(ground);
            $disLock.addToWorld();
        ...
        Hinge_html.prototype.hinge = function () {
            ...
            $disLock.addToWorld();
            var $disLock = new canonkey.CanonPrefabSprite(staticBody);
            $disLock.addToWorld();
        };
        return Hinge_html;
    }(canonkey.DemoBase_html));
    canonkey.Hinge_html = Hinge_html;
})(canonkey || (canonkey = {}));
