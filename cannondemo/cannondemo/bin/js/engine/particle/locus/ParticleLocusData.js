        ...
        (function (locus) {
            var ParticleLocusData = (function (_super) {
                ...
                ParticleLocusData.prototype.getParticle = function () {
                    return new locus.Display3DLocusPartilce;
                };
                ...
                ParticleLocusData.prototype.regShader = function () {
                    ...
                    this.materialParam.shader = ProgrmaManager.getInstance().getMaterialProgram(locus.Display3DLocusShader.Display3D_Locus_Shader, locus.Display3DLocusShader, this.materialParam.material, shaderParameAry);
                    this.materialParam.program = this.materialParam.shader.program;
                };
                ParticleLocusData.prototype.initVcData = function () {
                    this.vcmatData = new Float32Array(locus.Display3DLocusShader.getVcSize() * 16);
                };
                ParticleLocusData.prototype.setFloat32Vec = function (key, ary) {
                    var idxary = locus.Display3DLocusShader.shader_vec4[key];
                    var idx = idxary[0] * 16 + idxary[1] * 4;
                    this.vcmatData.set(ary, idx);
                };
                ParticleLocusData.prototype.setFloat32Mat = function (key, ary) {
                    var idx = locus.Display3DLocusShader.shader_mat4[key] * 16;
                    this.vcmatData.set(ary, idx);
                };
                return ParticleLocusData;
            }(engine.particle.ParticleData));
            locus.ParticleLocusData = ParticleLocusData;
