module Pan3d {
    export class ParticleData {
        ...
        public setAllByteInfo($byte: Pan3dByteArray): void {
            ...
            this._life = this._life > 10000 ? Scene3D.MAX_NUMBER : this._life;
        ...
        private set materialByteUrl(value: string) {
            ...
            this.scene3D.materialManager.getMaterialByte(this.scene3D.fileRoot + value, ($matrial: Material) => { this.onMaterialLoad($matrial) })
        }

        private onMaterialLoad($matrial: Material): void {
            this.materialParam = new MaterialParam(this.scene3D);
