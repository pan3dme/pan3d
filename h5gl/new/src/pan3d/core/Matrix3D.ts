module Pan3d {
    export class Matrix3D {
        ...
        public static tempM: Matrix3D = new Matrix3D();
        public clone($target: Matrix3D = null): Matrix3D {
        ...
        public invertToMatrix($target: Matrix3D): void {
            var a: Float32Array = this.m;
            var a00 = a[0], a01 = a[1], a02 = a[2], a03 = a[3],
                a10 = a[4], a11 = a[5], a12 = a[6], a13 = a[7],
                a20 = a[8], a21 = a[9], a22 = a[10], a23 = a[11],
        ...
        public append($matrx3d: Matrix3D): void {
        ...
        public prepend($matrx3d: Matrix3D): void {
            var b = $matrx3d.m
            var out: Float32Array = this.m;
            var a: Float32Array = this.m;
            var a00 = a[0], a01 = a[1], a02 = a[2], a03 = a[3],
