...
#import "Header.h"
@implementation Dt_AlertVo

@end

@interface Dt_AlertView ()
@property (nonatomic, strong)  Dt_AlertView *redBagAlertView;

@property (nonatomic, strong)  Dt_AlertVo *redBagAlertVo;

@end
@implementation Dt_AlertView
