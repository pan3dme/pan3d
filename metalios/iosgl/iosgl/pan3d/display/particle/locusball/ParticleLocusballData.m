...
@implementation ParticleLocusballData
...
- (void)setAllByteInfo:(ByteArray *)fs
{
    ...
    ByteArray* byte=fs;
    ParticleLocusballData* this=self;
    this._tangentSpeed =  [byte readFloat];
    this._posAry  = [NSJSONSerialization JSONObjectWithData:[[byte readUTF] dataUsingEncoding:NSUTF8StringEncoding] options:NSJSONReadingAllowFragments error:nil];
    this._angleAry = [NSJSONSerialization JSONObjectWithData:[[byte readUTF] dataUsingEncoding:NSUTF8StringEncoding] options:NSJSONReadingAllowFragments error:nil];
    this._tangentAry = [NSJSONSerialization JSONObjectWithData:[[byte readUTF] dataUsingEncoding:NSUTF8StringEncoding] options:NSJSONReadingAllowFragments error:nil];
