...
import com.pan3d.display.particle.ctrl.TimeLineData;
import com.pan3d.material.Material;
import com.pan3d.material.MaterialBackFun;
import com.pan3d.material.MaterialParam;
import com.pan3d.scene.Scene3D;
import com.pan3d.vo.CurveItemVo;
import com.pan3d.vo.CurveVo;
    ...
    private void readTempCurve(ByteArray $byte, CurveVo curve)
    {
        ...
        for (int j = 0; j < valuesLen; j++) {
            ...
            for (int k = 0; k < rgbLen; k++) {
                ...
                valuesArr.add($byte.readByte() / 127.f * scaleNum);
            }
